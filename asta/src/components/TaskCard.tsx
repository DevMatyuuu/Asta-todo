...
function TaskCard({task, index, id, innerRef, dragHandleProps, draggableProps,}: TaskCardProps) {
  ...
  return (
    <div {...draggableProps} {...dragHandleProps} ref={innerRef} className={`${isDark ? 'bg-gray-700/30  hover:bg-slate-500/20' : 'bg-white/60  hover:bg-slate-500/20'}  md:w-[400px] mt-10 py-1 mx-auto rounded-lg space-y-2 px-5 drop-shadow-md`}>
